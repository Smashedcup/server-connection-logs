--Configuration--
local discordwebhook = 'https://discord.com/api/webhooks/954197456168550410/0AoV5Gy7EqyBmlTTU12jan0T3_4rqLJhCPr7PQvzo-VxkwJpeprcS8ZU44A0YTDXLj6F'
...
function sendToDiscordLogsEmbed(color, name, message, footer)
  local footer = 'Made By Quackington Rp - '..os.date("%d/%m/%Y     %X")
  local embed = {
        {
            ["color"] = color,
            ["title"] = "**".. name .."**",
